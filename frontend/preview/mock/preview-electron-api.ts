...
const previewElectronApi: ElectronApi = {
    ...
    onUpdaterManualProgress: (_callback: (progress: UpdaterManualProgress) => void) => {},
    getUpdaterStatus: () => "up-to-date",
    getUpdaterManualProgress: () => null,
    ...
    exportHtml: (_fileName: string, _html: string) => Promise.resolve({ ok: false, canceled: true, filePath: null, error: null } as ExportResult),
    exportPdf: (_fileName: string, _html: string, _pdfOptions?: Record<string, unknown>) => Promise.resolve({ ok: false, canceled: true, filePath: null, error: null } as ExportResult),
    setIsActive: async () => {},
    startWindowDrag: () => {},
    endWindowDrag: () => {},
};
