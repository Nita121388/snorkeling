        ...
        <div className="mt-2 pt-2 border-t border-border">
            <div className="flex gap-2 overflow-x-auto pb-1">
                {fileParts.map((file, index) => (
                    <div key={index} className="relative bg-surface-strong rounded-lg p-2 min-w-20 flex-shrink-0">
                        <div className="flex flex-col items-center text-center">
                            <div className="w-12 h-12 mb-1 flex items-center justify-center bg-surface rounded overflow-hidden">
        ...
        <div className={cn("flex", message.role === "user" ? "justify-end" : "justify-start")}>
            <div
                className={cn(
                    ...
                    message.role === "user"
                        ? "py-2 bg-surface-strong text-primary max-w-[calc(100%-50px)]"
                        : "min-w-[min(100%,500px)]"
                )}
            >
