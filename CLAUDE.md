...
This project is indexed by GitNexus as **snorkeling** (25382 symbols, 72316 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
