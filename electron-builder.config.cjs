    ...
    mac: {
        ...
        extendInfo: {
            ...
            NSLocationWhenInUseUsageDescription:
                "A CLI application running in Snorkeling wants to use your location information while active.",
            NSLocationAlwaysUsageDescription:
                "A CLI application running in Snorkeling wants to use your location information, even in the background.",
