...
const (
	...
	TurnPersisted ChatEventType = "turn_persisted" // turn output confirmed on disk
...
type ChatEvent struct {
	...
	// turn_persisted: whether the backend confirmed the session file was
	// flushed before the confirmation deadline expired.
