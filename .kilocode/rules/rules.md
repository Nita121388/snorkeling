...
- For accent buttons, use "bg-action text-actiontext rounded hover:bg-actionhover transition-colors cursor-pointer". These semantic tokens preserve readable contrast and a lighter hover state in every app theme.
