...
| ui:locale <VersionBadge version="v0.14.5" />                         | string   | UI display language: `"en"` (English, default) or `"zh"` (中文). Requires a restart after changing in the config file to take full effect.                                                                                                                  |
