...
Wave ships with 6 default widgets in the widgets bar (terminal, agent, files, web, sysinfo, and processes). You can modify or remove these by overriding their config in widgets.json. The names of the 6 widgets, in order, are:
