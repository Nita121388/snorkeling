...
The Snorkeling fork does not introduce new keyboard shortcuts. The fork-specific workflows — [Agent launch](./agent-workflow), [AI Sessions browsing](./ai-sessions), and [Version Control](./version-control) — are accessed through the right sidebar entries rather than dedicated keybindings. All keybindings below remain valid in Snorkeling.
:::
